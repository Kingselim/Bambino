...
public class BabyController {
...

  {
    ...
    // http://localhost:8089/baby/modify/{id_baby}
    @PutMapping("/modify/{id_baby}")
    public Baby modifyBaby(@RequestBody Baby baby, @PathVariable("id_baby") Long id_baby) {
        baby.setIdBaby(id_baby);
