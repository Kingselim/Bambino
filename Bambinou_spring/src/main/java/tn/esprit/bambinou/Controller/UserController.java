...
public class UserController {
    ...
    @GetMapping("/available-for-nutrition")
    public ResponseEntity<List<User>> getUsersNotLinkedToNutrition() {
        return ResponseEntity.ok(userRepository.findUsersNotLinkedToNutrition());
    }
